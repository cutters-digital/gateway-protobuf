...
func (c *customerClient) GetCustomer(ctx context.Context, in *GetCustomerRequest, opts ...grpc.CallOption) (*GetCustomerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/payment.public.Customer/GetCustomer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Customer_GetCustomer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/payment.public.Customer/GetCustomer",
	}
...
var Customer_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "payment.public.Customer",
	...
	Metadata: "proto/payment/public_services.proto",
}
...
func (c *orderClient) GetOrder(ctx context.Context, in *GetOrderRequest, opts ...grpc.CallOption) (*GetOrderResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/payment.public.Order/GetOrder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Order_GetOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/payment.public.Order/GetOrder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Order_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "payment.public.Order",
