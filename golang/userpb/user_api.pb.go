...
type User struct {
	...
	AllowMarketing bool               `protobuf:"varint,11,opt,name=allow_marketing,json=allowMarketing,proto3" json:"allow_marketing,omitempty"` // DEPRECATED: Use consents instead.
	...
	Consents   *Consents `protobuf:"bytes,14,opt,name=consents,proto3" json:"consents,omitempty"`
	AppVersion string    `protobuf:"bytes,15,opt,name=app_version,json=appVersion,proto3" json:"app_version,omitempty"` // The version of the app installed by the user
}
...
func (x *User) GetConsents() *Consents {
	if x != nil {
		return x.Consents
	}
	return nil
...
type Consents struct {
	...
	TermsAndConditions bool `protobuf:"varint,1,opt,name=terms_and_conditions,json=termsAndConditions,proto3" json:"terms_and_conditions,omitempty"`
	MarketingSms       bool `protobuf:"varint,2,opt,name=marketing_sms,json=marketingSms,proto3" json:"marketing_sms,omitempty"`
	MarketingEmail     bool `protobuf:"varint,3,opt,name=marketing_email,json=marketingEmail,proto3" json:"marketing_email,omitempty"`
	MarketingPush      bool `protobuf:"varint,4,opt,name=marketing_push,json=marketingPush,proto3" json:"marketing_push,omitempty"`
}
...
func (x *Consents) GetTermsAndConditions() bool {
	if x != nil {
...
func (x *Consents) GetMarketingSms() bool {
	if x != nil {
...
func (x *Consents) GetMarketingEmail() bool {
	if x != nil {
...
func (x *Consents) GetMarketingPush() bool {
	if x != nil {
		return x.MarketingPush
	}
	return false
}
...
var file_proto_user_user_api_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xa5, 0x04, 0x0a, 0x04, 0x55, 0x73, 0x65,
	...
	,
	...
	0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x33, 0x0a, 0x0a, 0x55,
	...
	0x12, 0x33, 0x0a, 0x0a, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x12, 0x11,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x63, 0x0a, 0x16, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55,
	0x73, 0x65, 0x72, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12,
	0x23, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65,
	0x72, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x24, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x55, 0x70, 0x64, 0x61,
	...
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x63, 0x75, 0x74, 0x74, 0x65, 0x72, 0x73,
	0x2d, 0x64, 0x69, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x2f, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79,
	0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x67, 0x6f, 0x6c, 0x61, 0x6e, 0x67,
...
var file_proto_user_user_api_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_proto_user_user_api_proto_goTypes = []interface{}{
	...
	(*Consents)(nil),                       // 6: user.Consents
	(*authpb.Authentication)(nil),          // 7: auth.Authentication
	(*notificationspb.Notification)(nil),   // 8: notifications.Notification
	(*utilspb.Timestamp)(nil),              // 9: utils.Timestamp
}
var file_proto_user_user_api_proto_depIdxs = []int32{
	7,  // 0: user.UserRequest.auth:type_name -> auth.Authentication
	5,  // 1: user.UserRequest.user:type_name -> user.User
	5,  // 2: user.UserResponse.user:type_name -> user.User
	7,  // 3: user.UpdateUserNotificationRequest.auth:type_name -> auth.Authentication
	8,  // 4: user.UpdateUserNotificationRequest.notification:type_name -> notifications.Notification
	8,  // 5: user.User.notification:type_name -> notifications.Notification
	9,  // 6: user.User.birthday:type_name -> utils.Timestamp
	0,  // 7: user.User.gender:type_name -> user.Gender
	6,  // 8: user.User.consents:type_name -> user.Consents
	1,  // 9: user.UserAPI.CreateUser:input_type -> user.UserRequest
	1,  // 10: user.UserAPI.GetUser:input_type -> user.UserRequest
	1,  // 11: user.UserAPI.UpdateUser:input_type -> user.UserRequest
	1,  // 12: user.UserAPI.DeleteUser:input_type -> user.UserRequest
	3,  // 13: user.UserAPI.UpdateUserNotification:input_type -> user.UpdateUserNotificationRequest
	2,  // 14: user.UserAPI.CreateUser:output_type -> user.UserResponse
	2,  // 15: user.UserAPI.GetUser:output_type -> user.UserResponse
	2,  // 16: user.UserAPI.UpdateUser:output_type -> user.UserResponse
	2,  // 17: user.UserAPI.DeleteUser:output_type -> user.UserResponse
	4,  // 18: user.UserAPI.UpdateUserNotification:output_type -> user.UpdateUserNotificationResponse
...
func file_proto_user_user_api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_user_user_api_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
