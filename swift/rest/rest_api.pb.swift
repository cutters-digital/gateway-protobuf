...
public enum Rest_NotificationType: SwiftProtobuf.Enum {
...
extension Rest_NotificationType: CaseIterable {
...
public enum Rest_VoucherNotificationType: SwiftProtobuf.Enum {
  public typealias RawValue = Int
  case invalid // = 0
...
extension Rest_VoucherNotificationType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public struct Rest_NotificationRequest {
...
public struct Rest_NotificationResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Rest_UpdateServiceRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Rest_UpdateServiceResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Rest_VoucherNotificationRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Rest_VoucherNotificationResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Rest_ServiceUpdate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Rest_NotificationType: @unchecked Sendable {}
extension Rest_VoucherNotificationType: @unchecked Sendable {}
extension Rest_NotificationRequest: @unchecked Sendable {}
extension Rest_NotificationResponse: @unchecked Sendable {}
extension Rest_UpdateServiceRequest: @unchecked Sendable {}
extension Rest_UpdateServiceResponse: @unchecked Sendable {}
extension Rest_VoucherNotificationRequest: @unchecked Sendable {}
extension Rest_VoucherNotificationResponse: @unchecked Sendable {}
extension Rest_ServiceUpdate: @unchecked Sendable {}
