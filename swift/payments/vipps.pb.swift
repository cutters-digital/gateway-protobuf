...
public enum Payments_VippsPaymentOperation: SwiftProtobuf.Enum {
...
extension Payments_VippsPaymentOperation: CaseIterable {
...
public struct Payments_VippsPaymentRequest {
...
public struct Payments_VippsPaymentResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Payments_VippsPaymentOperation: @unchecked Sendable {}
extension Payments_VippsPaymentRequest: @unchecked Sendable {}
extension Payments_VippsPaymentResponse: @unchecked Sendable {}
