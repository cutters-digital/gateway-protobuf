...
public enum Server_HistoricalTransactionState: SwiftProtobuf.Enum {
...
extension Server_HistoricalTransactionState: CaseIterable {
...
public enum Server_BookingStatus: SwiftProtobuf.Enum {
  public typealias RawValue = Int
  case invalid // = 0
  case unknown // = 1
  case registered // = 2
...
extension Server_BookingStatus: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public enum Server_ServiceStatus: SwiftProtobuf.Enum {
  public typealias RawValue = Int
  case invalid // = 0
...
extension Server_ServiceStatus: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public enum Server_WaitingTimePrecision: SwiftProtobuf.Enum {
  public typealias RawValue = Int
  case invalid // = 0
...
extension Server_WaitingTimePrecision: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public struct Server_AvailableHairdressersRequest {
...
public struct Server_AvailableHairdressersResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_Hairdresser {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_GetWaitingTimesRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Server_GetWaitingTimesRequest.OneOf_Mode, rhs: Server_GetWaitingTimesRequest.OneOf_Mode) -> Bool {
...
public struct Server_GetWaitingTimesResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_GetSalonRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_GetSalonResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_BookRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_BookResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_PurchaseRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var awareOfCampaigns: Bool = false
...
public struct Server_PurchaseResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_GetAvailablePaymentProvidersRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_GetAvailablePaymentProvidersResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_GetPriceRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_GetPriceResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_GetCampaignsRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_GetCampaignsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_GetServicesRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_GetServicesResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_GetProductsRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_GetProductsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_GetWaitingStatusRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_GetWaitingStatusResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_ListTransactionsRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_ListTransactionsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_CanRedeemVoucherRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_CanRedeemVoucherResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_CreateVoucherRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_CreateVoucherResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_GetReferralStatusRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_GetReferralStatusResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_CancelServiceRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_CancelServiceResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_RemoteLogRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_RemoteLogResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_TimeoutRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_TimeoutResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_ListActiveTransactionsRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_ListActiveTransactionsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_ListHistoricalTransactionsRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_ListHistoricalTransactionsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_BookingDetails {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_OpeningTime {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_Timetable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_ServiceTransaction {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_ProductTransaction {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// ServiceTransaction describes a purchased service.
public struct Server_ActiveServiceTransaction {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// ProductTransaction describes a purchased product.
public struct Server_ActiveProductTransaction {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// ServiceTransaction describes a purchased service.
public struct Server_HistoricalServiceTransaction {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// ProductTransaction describes a purchased product.
public struct Server_HistoricalProductTransaction {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_SalonInfo {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_ReadableWaitingTime {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Server_AvailablePaymentProviders {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Server_HistoricalTransactionState: @unchecked Sendable {}
extension Server_BookingStatus: @unchecked Sendable {}
extension Server_ServiceStatus: @unchecked Sendable {}
extension Server_WaitingTimePrecision: @unchecked Sendable {}
extension Server_AvailableHairdressersRequest: @unchecked Sendable {}
extension Server_AvailableHairdressersResponse: @unchecked Sendable {}
extension Server_Hairdresser: @unchecked Sendable {}
extension Server_GetWaitingTimesRequest: @unchecked Sendable {}
extension Server_GetWaitingTimesRequest.OneOf_Mode: @unchecked Sendable {}
extension Server_GetWaitingTimesResponse: @unchecked Sendable {}
extension Server_GetSalonRequest: @unchecked Sendable {}
extension Server_GetSalonResponse: @unchecked Sendable {}
extension Server_BookRequest: @unchecked Sendable {}
extension Server_BookResponse: @unchecked Sendable {}
extension Server_PurchaseRequest: @unchecked Sendable {}
extension Server_PurchaseResponse: @unchecked Sendable {}
extension Server_GetAvailablePaymentProvidersRequest: @unchecked Sendable {}
extension Server_GetAvailablePaymentProvidersResponse: @unchecked Sendable {}
extension Server_GetPriceRequest: @unchecked Sendable {}
extension Server_GetPriceResponse: @unchecked Sendable {}
extension Server_GetCampaignsRequest: @unchecked Sendable {}
extension Server_GetCampaignsResponse: @unchecked Sendable {}
extension Server_GetServicesRequest: @unchecked Sendable {}
extension Server_GetServicesResponse: @unchecked Sendable {}
extension Server_GetProductsRequest: @unchecked Sendable {}
extension Server_GetProductsResponse: @unchecked Sendable {}
extension Server_GetWaitingStatusRequest: @unchecked Sendable {}
extension Server_GetWaitingStatusResponse: @unchecked Sendable {}
extension Server_ListTransactionsRequest: @unchecked Sendable {}
extension Server_ListTransactionsResponse: @unchecked Sendable {}
extension Server_CanRedeemVoucherRequest: @unchecked Sendable {}
extension Server_CanRedeemVoucherResponse: @unchecked Sendable {}
extension Server_CreateVoucherRequest: @unchecked Sendable {}
extension Server_CreateVoucherResponse: @unchecked Sendable {}
extension Server_GetReferralStatusRequest: @unchecked Sendable {}
extension Server_GetReferralStatusResponse: @unchecked Sendable {}
extension Server_CancelServiceRequest: @unchecked Sendable {}
extension Server_CancelServiceResponse: @unchecked Sendable {}
extension Server_RemoteLogRequest: @unchecked Sendable {}
extension Server_RemoteLogResponse: @unchecked Sendable {}
extension Server_TimeoutRequest: @unchecked Sendable {}
extension Server_TimeoutResponse: @unchecked Sendable {}
extension Server_ListActiveTransactionsRequest: @unchecked Sendable {}
extension Server_ListActiveTransactionsResponse: @unchecked Sendable {}
extension Server_ListHistoricalTransactionsRequest: @unchecked Sendable {}
extension Server_ListHistoricalTransactionsResponse: @unchecked Sendable {}
extension Server_BookingDetails: @unchecked Sendable {}
extension Server_OpeningTime: @unchecked Sendable {}
extension Server_Timetable: @unchecked Sendable {}
extension Server_Salon: @unchecked Sendable {}
extension Server_Location: @unchecked Sendable {}
extension Server_ServiceTransaction: @unchecked Sendable {}
extension Server_ProductTransaction: @unchecked Sendable {}
extension Server_ActiveServiceTransaction: @unchecked Sendable {}
extension Server_ActiveProductTransaction: @unchecked Sendable {}
extension Server_HistoricalServiceTransaction: @unchecked Sendable {}
extension Server_HistoricalProductTransaction: @unchecked Sendable {}
extension Server_SalonInfo: @unchecked Sendable {}
extension Server_ReadableWaitingTime: @unchecked Sendable {}
extension Server_AvailablePaymentProviders: @unchecked Sendable {}
...
extension Server_PurchaseRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 6: try { try decoder.decodeSingularBoolField(value: &self.awareOfCampaigns) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.awareOfCampaigns != false {
      try visitor.visitSingularBoolField(value: self.awareOfCampaigns, fieldNumber: 6)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: Server_PurchaseRequest, rhs: Server_PurchaseRequest) -> Bool {
    ...
    if lhs.products != rhs.products {return false}
    if lhs._payment != rhs._payment {return false}
    if lhs.awareOfCampaigns != rhs.awareOfCampaigns {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
