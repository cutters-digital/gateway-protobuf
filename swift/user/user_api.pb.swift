...
public enum User_Gender: SwiftProtobuf.Enum {
...
extension User_Gender: CaseIterable {
...
public struct User_UserRequest {
...
public struct User_UserResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct User_UpdateUserNotificationRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct User_UpdateUserNotificationResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension User_Gender: @unchecked Sendable {}
extension User_UserRequest: @unchecked Sendable {}
extension User_UserResponse: @unchecked Sendable {}
extension User_UpdateUserNotificationRequest: @unchecked Sendable {}
extension User_UpdateUserNotificationResponse: @unchecked Sendable {}
