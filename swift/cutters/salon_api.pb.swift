...
public enum Cutters_Currency: SwiftProtobuf.Enum {
...
extension Cutters_Currency: CaseIterable {
...
public struct Cutters_GetSalonRequest {
...
public struct Cutters_GetSalonResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Cutters_ListSalonsRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Cutters_ListSalonsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Cutters_Identity {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Cutters_Locality {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Cutters_Coordinates {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Cutters_PaymentProviders {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Cutters_Schedule {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Cutters_Exception {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Cutters_Hairdressers {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Cutters_Hairdresser {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Cutters_Currency: @unchecked Sendable {}
extension Cutters_GetSalonRequest: @unchecked Sendable {}
extension Cutters_GetSalonResponse: @unchecked Sendable {}
extension Cutters_ListSalonsRequest: @unchecked Sendable {}
extension Cutters_ListSalonsResponse: @unchecked Sendable {}
extension Cutters_Salon: @unchecked Sendable {}
extension Cutters_Identity: @unchecked Sendable {}
extension Cutters_Locality: @unchecked Sendable {}
extension Cutters_Coordinates: @unchecked Sendable {}
extension Cutters_Shop: @unchecked Sendable {}
extension Cutters_PaymentProviders: @unchecked Sendable {}
extension Cutters_Schedule: @unchecked Sendable {}
extension Cutters_Regular: @unchecked Sendable {}
extension Cutters_Day: @unchecked Sendable {}
extension Cutters_Instant: @unchecked Sendable {}
extension Cutters_Exception: @unchecked Sendable {}
extension Cutters_Hairdressers: @unchecked Sendable {}
extension Cutters_Hairdresser: @unchecked Sendable {}
extension Cutters_Queue: @unchecked Sendable {}
