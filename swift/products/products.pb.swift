...
public struct Products_ActiveLineItem {
...
public struct Products_HistoricalLineItem {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Products_Product {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Products_ProductRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Products_Service {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Products_ServiceRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Products_ActiveLineItem: @unchecked Sendable {}
extension Products_HistoricalLineItem: @unchecked Sendable {}
extension Products_Product: @unchecked Sendable {}
extension Products_ProductRequest: @unchecked Sendable {}
extension Products_Service: @unchecked Sendable {}
extension Products_ServiceRequest: @unchecked Sendable {}
